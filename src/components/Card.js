export default class Card {
  constructor({data, userId, handleCardClick, handleLikeAdd, handleLikeDelete, handleDelete}, templateSelector) {
  ...
  _isLiked() {
    if (this._likes.some((user) => {
       ...
       this._likeButton.classList.add('list__toggle_active');
    }
 }
